...
class NodeRed {
    ...
    public function getCentriDiLavoro($cdl = NULL, $ip = NULL, $id = NULL, $codiceGruppo = NULL, $codiceSquadra = NULL) {
        ...
        return HttpCalls::get($url,["Authorization: Basic ".$this->authToken]);
    }
    ...
    public function putRunningTask($data) {
        ...
        return HttpCalls::put($url,$data,"application/json",["Authorization: Basic ".$this->authToken]);
    }
    ...
    public function postSKillOperatori($data) {
        ...
        return HttpCalls::post($url,$data,"application/json",["Authorization: Basic ".$this->authToken]); 
    }
    ...
    public function deleteRunningTask($runningTaskId) {
        ...
        $url = $this->baseUrl."/running-task";
        return HttpCalls::delete($url,$data,"application/json",["Authorization: Basic ".$this->authToken]);
    }
